...
(library Library_1
	...
	(patternDef "SHDR10W64P254X254_2X5_2036X885" (originalName "SHDR10W64P254X254_2X5_2036X885")
		...
		(layerContents (layerNumRef 28)
			(line (pt -5.25 -3.305) (pt -5.25 5.695) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -5.25 5.695) (pt 15.26 5.695) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 15.26 5.695) (pt 15.26 -3.305) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 15.26 -3.305) (pt -5.25 -3.305) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "61201021621" (originalName "61201021621") (compHeader (numPins 10) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "http://docs-europe.electrocomponents.com/webdocs/13f3/0900766b813f3580.pdf")
